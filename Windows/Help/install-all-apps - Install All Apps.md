...
WHAT IT DOES
Run the five bundled application installers in sequence. Their setup windows may require input and Internet access. Excludes WinUtil and Win11Debloat.

LOCATION
Deployment > Install All Apps
