Toolkit Integrity Self-Test
===========================

WHAT IT DOES
Validate the current Field Kit package, tool mappings, script syntax, category mappings, and immutable source hashes.

LOCATION
System Management > Toolkit Integrity Self-Test
