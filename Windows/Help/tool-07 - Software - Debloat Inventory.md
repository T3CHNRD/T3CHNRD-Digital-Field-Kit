Software / Debloat Inventory
============================

WHAT IT DOES
Inventory installed and provisioned applications without automatically removing them.

LOCATION
Diagnostics > Software / Debloat Inventory
...
BUNDLED SCRIPT
Windows\Scripts\Invoke-DebloatInventory.ps1
