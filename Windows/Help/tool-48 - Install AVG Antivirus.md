...
WHAT IT DOES
Launch the bundled AVG Antivirus installer supplied in the new-computer setup package. The original bootstrap installer may require Internet access; its own setup window will open.

LOCATION
Deployment > Install AVG Antivirus
...
Configured arguments: -Installer avg_antivirus_free_setup.exe
