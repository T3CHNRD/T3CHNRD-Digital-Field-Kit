Embedded Runner Self-Test
=========================

WHAT IT DOES
Verify that the app can launch hidden Windows PowerShell and receive a completed result through the Run Center.

LOCATION
System Management > Embedded Runner Self-Test
...
BUNDLED SCRIPT
Windows\App\Embedded-Runner-SelfTest.ps1
