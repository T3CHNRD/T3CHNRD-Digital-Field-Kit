PowerShell Risk Scan
====================

WHAT IT DOES
Scan PowerShell scripts for potentially risky constructs.

LOCATION
Security > PowerShell Risk Scan
...
BUNDLED SCRIPT
Windows\Scripts\Security\Invoke-PowerShellRiskScan.ps1
