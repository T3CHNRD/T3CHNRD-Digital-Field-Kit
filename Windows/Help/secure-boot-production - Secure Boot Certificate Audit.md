...
WHAT IT DOES
Run the supplied production audit for this PC with a local report directory. Remediation is not enabled.

LOCATION
Security > Secure Boot Certificate Audit
...
Configured arguments: -Mode Production
