Secure Boot Multi-Computer Audit
================================

WHAT IT DOES
Run the supplied multi-computer audit for this PC and save output in Diagnostic-Reports.

LOCATION
Security > Secure Boot Multi-Computer Audit
...
BUNDLED SCRIPT
Windows\Scripts\Security\Invoke-BundledSecureBootAudit.ps1
Configured arguments: -Mode Multi
