...
WHAT IT DOES
Launch the bundled Chrome installer supplied in the new-computer setup package. The original bootstrap installer may require Internet access; its own setup window will open.

LOCATION
Deployment > Install Google Chrome
...
Configured arguments: -Installer ChromeSetup (1).exe
