...
WHAT IT DOES
Collect recent BugCheck, Kernel-Power, WHEA, storage, application crash, and Windows Error Reporting evidence.

LOCATION
Diagnostics > BSOD / Crash Report
...
BUNDLED SCRIPT
Windows\Scripts\Core\Collect-BSODCrashReport.ps1
