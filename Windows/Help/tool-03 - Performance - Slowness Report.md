Performance / Slowness Report
=============================

WHAT IT DOES
Collect CPU, memory, disks, startup programs, drivers, and live performance counters.

LOCATION
Diagnostics > Performance / Slowness Report
...
BUNDLED SCRIPT
Windows\Scripts\Core\Collect-SlownessReport.ps1
