Application Integrity Self-Test
===============================

WHAT IT DOES
Validate the current Field Kit package, tool mappings, PowerShell syntax, and immutable restored-script hashes.

LOCATION
System Management > Application Integrity Self-Test
