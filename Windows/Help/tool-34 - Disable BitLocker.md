...
WHAT IT DOES
Decrypt/disable BitLocker on a selected volume.

LOCATION
Security > Disable BitLocker

HOW TO RUN
Open Tools, choose the category above, and click the tool card.
Review the selected volume before decrypting. Confirm recovery keys are backed up and wait for the reported decryption status.
...
BUNDLED SCRIPT
Windows\Scripts\Invoke-DisableBitLocker.ps1
