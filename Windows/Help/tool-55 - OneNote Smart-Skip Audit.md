OneNote Smart-Skip Audit
========================

WHAT IT DOES
Site-specific OneNote audit/import workflow.

LOCATION
System Management > OneNote Smart-Skip Audit

HOW TO RUN
Open Tools, choose the category above, and click the tool card.
Review the original site-specific notebook and import paths before running. Verify the target notebook and inspect audit output before making changes.
...
BUNDLED SCRIPT
Windows\Scripts\Documentation\Master-Audit-Smart-Skip.ps1
