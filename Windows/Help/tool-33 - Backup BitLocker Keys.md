...
WHAT IT DOES
Back up existing BitLocker recovery information.

LOCATION
Security > Backup BitLocker Keys

HOW TO RUN
Open Tools, choose the category above, and click the tool card.
Treat exported recovery keys as sensitive. Store them in an approved protected location; do not include keys in AI uploads.
...
BUNDLED SCRIPT
Windows\Scripts\Invoke-BackupBitLockerKeys.ps1
