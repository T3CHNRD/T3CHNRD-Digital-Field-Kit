Secure Boot Quick Check
=======================

WHAT IT DOES
Check Secure Boot status and Windows UEFI CA 2023 presence.

LOCATION
Security > Secure Boot Quick Check
...
BUNDLED SCRIPT
Windows\Scripts\Security\Check-SecureBootCert-Quick.ps1
