...
WHAT IT DOES
Launch the bundled Firefox installer supplied in the new-computer setup package. The original bootstrap installer may require Internet access; its own setup window will open.

LOCATION
Deployment > Install Mozilla Firefox
...
Configured arguments: -Installer Firefox Installer.exe
