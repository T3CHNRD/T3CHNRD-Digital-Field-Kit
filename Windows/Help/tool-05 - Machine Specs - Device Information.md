Machine Specs / Device Information
==================================

WHAT IT DOES
Report manufacturer/model, CPU, RAM, BIOS, Windows build, disks and network adapters. Saves a text report in Diagnostic-Reports.

LOCATION
Diagnostics > Machine Specs / Device Information
...
BUNDLED SCRIPT
Windows\Scripts\Invoke-DeviceInformationReport.ps1
